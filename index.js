...
bot.command('saferugwallet', (ctx) => ctx.reply("the saferug wallet link is " + 'https://bscscan.com/address/0x00c6efa79ccd7d184e207ea48f09726e89a33249' + " ser"))
bot.command('howtobuy', (ctx) => ctx.reply("saferug cannot be bought on pancakeswap or other exchanges. to buy, you have to visit " + 'https://app.bounce.finance/fixed-swap/5350' + " ser"))
...
bot.command('v1', (ctx) => ctx.reply("the saferug v1 token gets explained here, ser: " + 'https://docs.saferug.money/security/v1-exploit'))
bot.command('v2', (ctx) => ctx.reply("the saferug v2 token gets explained here, ser: " + 'https://docs.saferug.money/security/v2'))
bot.command('soon', (ctx) => ctx.reply("current development plans can be viewed here, ser: " + 'https://docs.saferug.money/in-the-pipeworks/ecosystem'))
...
bot.command('theme', (ctx) => 
    ctx.forward_message(chat_id='-1001333132713',
                        from_chat_id='-1001333132713',
                        message_id='2255')
)
bot.launch()
